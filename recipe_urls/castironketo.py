...
class CastIronKetoScraper(AbstractScraper):
    ...
    def scrape(self) -> List[str]:
        ...
        if not href_links:
            print(f"[castironketo.py] Warning: href_links is empty for {self.base_url}")
    ...
    def filter_links(self, href_links: List[str]) -> List[str]:
        ...
        # Site-specific regex for CastIronKeto
        ...
        if not unique_links_set:
            raise ValueError("[castironketo.py] No recipe links matched the defined pattern for CastIronKeto.")
